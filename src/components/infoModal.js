    ...
    return(    
        ...
        >
            ...
            <Modal.Body className='dark-bg-body'>
                ...
                <p>- To convert an intergalactic number to an arabic number, use the following format: "how much is <b>intergalactic-numeral</b> ?" E.g. <i>how much is pish tegj glob glob ?</i></p>
